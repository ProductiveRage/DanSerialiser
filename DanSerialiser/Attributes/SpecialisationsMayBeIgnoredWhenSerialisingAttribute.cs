...
namespace DanSerialiser
{
	// ================================================================================================================================================================================
	// TODO
	//  - Analyser for this (and tests for analyser)
	//  - Update summary to provide example and counter-example of where this attribute may apply
	//    > Need  to expose SpeedyButLimited in order to do that!
	// ================================================================================================================================================================================
	...
	/// to perform more aggressive optimisations if the serialiser is configured to do so. It might be applied, for example, to a property of type Dictionary&lt;int, string&gt; if it
	/// is known that the property will only ever be assigned a value of that type (and not a more specialised type that is derived from it) AND if values will never have a custom
	/// equality comparer specified.
	/// 
